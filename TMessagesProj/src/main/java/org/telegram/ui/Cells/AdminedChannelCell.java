...
public class AdminedChannelCell extends FrameLayout {
    ...
    public AdminedChannelCell(Context context, View.OnClickListener onClickListener) {
        ...
        statusTextView.setTextColor(Theme.usePlusTheme ? Theme.prefSummaryColor : Theme.getColor(Theme.key_windowBackgroundWhiteGrayText));
        statusTextView.setLinkTextColor(Theme.usePlusTheme ? Theme.prefSectionColor : Theme.getColor(Theme.key_windowBackgroundWhiteLinkText));
        ...
        deleteButton.setColorFilter(new PorterDuffColorFilter(Theme.usePlusTheme ? Theme.prefSummaryColor : Theme.getColor(Theme.key_windowBackgroundWhiteGrayText), PorterDuff.Mode.MULTIPLY));
