...
public class SharedLinkCell extends FrameLayout {
    ...
    public SharedLinkCell(Context context) {
        ...
        titleTextPaint.setColor(Theme.usePlusTheme ? Theme.prefTitleColor : Theme.getColor(Theme.key_windowBackgroundWhiteBlackText));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (descriptionLayout != null) {
            descriptionTextPaint.setColor(Theme.usePlusTheme ? Theme.prefSummaryColor : Theme.getColor(Theme.key_windowBackgroundWhiteBlackText));
            canvas.save();
        ...
        if (!linkLayout.isEmpty()) {
            descriptionTextPaint.setColor(Theme.usePlusTheme ? Theme.prefSummaryColor : Theme.getColor(Theme.key_windowBackgroundWhiteLinkText));
            int offset = 0;
            for (int a = 0; a < linkLayout.size(); a++) {
                StaticLayout layout = linkLayout.get(a);
                if (layout.getLineCount() > 0) {
